...
fun main() {
    val exampleResult1 = getCalibrationValue(exampleInput1)
    println("Example 1: $exampleResult1")

    val exampleResult2 = getCalibrationValue(exampleInput2)
    println("Example 2: $exampleResult2")
